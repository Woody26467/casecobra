    ...
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <h1 className="mt-2 text-4xl font-bold tracking-tight sm:text-5">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-x-6 border-zinc-200 py-10 text-sm">
            <div>
            ...
            <div>
              ...
              <p className="mt-2 text-zinc-700">
                Royal Mail, takes up to 3 working days
              </p>
            </div>
          </div>
        </div>
